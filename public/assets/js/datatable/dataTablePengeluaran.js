...
$(document).ready(function () {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Hapus" id="hapus-data-pengeluaran">
    ...
    tablePengeluaran.on("click", "#edit-data-pengeluaran", function () {
        ...
        modal.find("#pengeluaran_id").val(data.id);
    ...
    tablePengeluaran.on("click", "#hapus-data-pengeluaran", function () {
        let modal = $("#modal-delete-data-pengeluaran");
        let data = tablePengeluaran
            .DataTable()
            .row($(this).parents("tr"))
            .data();
        ...
        modal.modal("show");
        modal.find("#pengeluaran_id").val(data.id);
        modal.find("#kategori_pengeluaran").html(data.kategori_pengeluaran);
    });
});